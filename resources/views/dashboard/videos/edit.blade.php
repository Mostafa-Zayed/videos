        ...
        <div class='card'>
            <div class='card-body'>
                ...
                @if(isset($videoId) && !empty($videoId))
                    <iframe width="380" src="https://www.youtube.com/embed/{{$videoId}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                    </iframe>
                    <div>
